...
class StringTest < Minitest::Homework
  ...
  def test_square_brackets
    ...
    # brackets with multiple args, indicates start index
    # and number of characters to return (including start)
  ...
  def test_sub
    # sub will replace only the *first* instance
